...
async function sendOvhSms(message: string, receiver: string) {
  ...
  // Repéré le 21/09/2026 : ce garde-fou renvoyait sans la moindre trace
  // (aucun console.error), indiscernable d'un SMS parti avec succès dans
  // les logs — un secret manquant/mal nommé passait totalement inaperçu.
  // Le message liste explicitement lequel manque, plutôt qu'un simple
  // booléen à recouper manuellement avec les 5 variables.
