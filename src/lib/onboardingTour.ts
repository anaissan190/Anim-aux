...
const DOCTOR_STEPS: TourStep[] = [
  ...
  { key: 'doctor-tab:tarifs', title: 'Vos tarifs', body: 'Vos prestations, leur prix et leur durée, tels que vos patients les voient à la réservation.' },
  { key: 'doctor-tab:avis', title: 'Vos avis', body: 'Les avis laissés par vos patients, avec la possibilité de leur répondre.' },
  { key: 'doctor-tab:stats', title: 'Vos statistiques', body: 'Vos rendez-vous et votre activité en chiffres.' },
  { key: 'doctor-tab:cabinet', title: 'Votre cabinet', body: 'L\u2019agenda partagé, l\u2019équipe et les statistiques de votre cabinet.' },
