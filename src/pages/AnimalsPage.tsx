  ...
  return (
    <div className="relative min-h-screen bg-sage-50">
      <div className="relative z-10">
        ...
        <div className="md:hidden pb-28 min-h-screen bg-[#FFFAF0] animate-mobile-slide-in">
        ...
        {/* Hors du conteneur animate-mobile-slide-in : son transform (laissé
            actif en permanence par le fill-mode "both" de l'animation)
